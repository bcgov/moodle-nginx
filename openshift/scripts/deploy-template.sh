...
create_or_update_configmap "check-pod-logs-script" "check-pod-logs.sh=./openshift/scripts/check-pod-logs.sh" "_utils.sh=./openshift/scripts/_utils.sh" "/usr/local/bin/includes/moodle_content_replacement_columns.csv=./openshift/scripts/includes/moodle_content_replacement_columns.csv"
